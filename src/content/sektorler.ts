...
export const SEKTORLER: Sektor[] = [
  {
    ...
    ornek: {
      ...
      toplam: "6.540 ₺",
      altNot: "Müşteri 2 kez açtı · son açılış bugün 14:20",
    },
  },
  {
    anahtar: "mobilya",
    ad: "Mobilya / Mutfak / Dekorasyon",
    kisaAd: "Mobilya",
    ikon: "sofa",
    baslik: "Ölçü değişti, fiyat değişti: revize edin, link aynı kalsın.",
    aciklama:
      "Mutfak ve mobilya işlerinde teklif birkaç kez değişir. Proformium'da gönderilmiş teklifi revize edersiniz; " +
      "Rev. 1, Rev. 2 geçmişi saklanır, müşterinin elindeki link hep son hali gösterir. Müşteri de sayfadan revize isteyebilir.",
    maddeler: [
  ...
  },
  {
    ...
    aciklama:
      "Teklif İste ile kalemleri yazar, tedarikçileri seçersiniz; her birine kendi linki gider. Tedarikçiler üye olmadan " +
      "fiyat yazar, siz fiyatları karşılaştırıp kazananı seçersiniz. Sonra müşteriye kendi teklifinizi hazırlarsınız.",
    maddeler: [
